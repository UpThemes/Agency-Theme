...
add_action( 'after_setup_theme', 'agency_register_portfolio' );
...
add_action( 'after_setup_theme', 'agency_register_testimonials' );
...
add_action( 'after_setup_theme', 'agency_register_team_members' );
